...
This repository is a fork of the unmaintained https://github.com/TeamSupercell/typings-for-css-modules-loader repository,
which in turn was a fork of the unmaintained https://github.com/Jimdo/typings-for-css-modules-loader repository.

Will this be better-maintained? Possibly not.

## Installation

Install via npm `npm install --save-dev @audioboom/typings-for-css-modules-loader`
    ...
    rules: [
      {
        ...
        use: [
          "style-loader",
          "@audioboom/typings-for-css-modules-loader",
          {
            loader: "css-loader",
